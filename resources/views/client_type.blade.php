                          ...
                          <table id="datatable" class="table table-hover table-bordered">
                              ...
                              @foreach($query_client_type as $data)
                                  ...
                                  <!--  -->
                                      ...
                                      <td style='line-height: 0.5;padding: .5rem;text-align: center'>{{$data->client_type_status}}</td>

                                      <td class='td_css' style='line-height: 0.5;padding: .5rem;text-align: center'>

                                      <a  href='{{url("admin/update_page_client_type/$data->id")}}' name="btn_edit" class="btn btn-info" style='line-height: 0.5;padding: .5rem'><i class="bi bi-pen"></i></a>
