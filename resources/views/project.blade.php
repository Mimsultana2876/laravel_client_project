                ...
                <div id="insert_form" class="col-12  w-75 m-auto">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action='{{url("admin/insert_project_info")}}' method="POST"  class="form-horizontal form-material mx-2">
                              @csrf
...
{{-- =======================================================================================================
    ...
    ==================================================================================================== --}}
                                ...
                                <table id="datatable-domain" class="table table-hover table-bordered">
                                    ...
                                    @foreach($query_domain_info as $data)
                                        ...
                                        <!--  -->
                                            ...
                                            <td id="domain_id" style='line-height: 0.5;padding: .5rem;text-align: center; display:none !important;'>{{$data->id}}
                                            </td>
                                            ...
                                            <td style='line-height: 0.5;padding: .5rem; text-align: center'>{{$data->domain_name}}</td>
                                            <td style='line-height: 0.5;padding: .5rem; text-align: center'>{{$data->domain_start_date}}</td>
                                            <td style='line-height: 0.5;padding: .5rem; text-align: center'>{{$data->domain_end_date}}</td>
                                ...
                                <table id="datatable-hosting" class="table table-hover table-bordered">
                                    ...
                                    @foreach($query_hosting_info as $data)
                                        ...
                                        <input type="hidden" id="hosting_unique_id" name="custId" value="{{$data->c_type_id}}">
                                            ...
                                            <!-- <input type="hidden" id="domain_id" name="domain_id" value="{{$data->id}}"> -->
                                            <td id="hosting_id" style='line-height: 0.5;padding: .5rem;text-align: center; display:none !important;'>{{$data->id}}
                                            <td style='line-height: 0.5;padding: .5rem;text-align: center'>{{$loop->index+1}}
                                            </td>
                                            <td style='line-height: 0.5;padding: .5rem;text-align: center'>{{$data->client_type_name}}</td>
                                            <td style='line-height: 0.5;padding: .5rem;text-align: center'>{{$data->c_name}}</td>
                                            <td style='line-height: 0.5;padding: .5rem; text-align: center'>{{$data->hosting_name}}</td>
                                            <td style='line-height: 0.5;padding: .5rem; text-align: center'>{{$data->hosting_start_date}}</td>
                                            <td class='td_css' style='line-height: 0.5;padding: .5rem;text-align: center'>
                                            <a id="edit_btn" class="edit_btn" pid="{{$data->id}}" name="btn_edit" class="btn btn-info" style='line-height: 0.5;padding: .5rem'><i class="bi bi-pen"></i></a>
                                            <form class="spacing" method="POST" action='{{url("admin/delete/clientInfoModel/$data->id")}}'>
                                                @csrf
                                ...
                                <table id="datatable-project" class="table table-hover table-bordered">
                                    ...
                                    @foreach($query_other_project_info as $data)
                                        ...
                                        <input type="hidden" id="project_unique_id" name="custId" value="{{$data->c_type_id}}">
                                            ...
                                            <!-- <input type="hidden" id="domain_id" name="domain_id" value="{{$data->id}}"> -->
                                            <td id="project_id" style='line-height: 0.5;padding: .5rem;text-align: center; display:none !important;'>{{$data->id}}
                                            <td style='line-height: 0.5;padding: .5rem;text-align: center'>{{$loop->index+1}}
                                            </td>
                                            <td style='line-height: 0.5;padding: .5rem;text-align: center'>{{$data->client_type_name}}</td>
                                            <td style='line-height: 0.5;padding: .5rem;text-align: center'>{{$data->c_name}}</td>
                                            <td style='line-height: 0.5;padding: .5rem; text-align: center'>{{$data->project_name}}</td>
                                            <td style='line-height: 0.5;padding: .5rem; text-align: center'>{{$data->project_details}}</td>
                                            <td style='line-height: 0.5;padding: .5rem; text-align: center'>{{$data->project_start_date}}</td>
                                            <td style='line-height: 0.5;padding: .5rem; text-align: center'>{{$data->project_time_quote}}</td>
                                            <td class='td_css' style='line-height: 0.5;padding: .5rem;text-align: center'>
                                            <a id="edit_btn" class="edit_btn" pid="{{$data->id}}" name="btn_edit" class="btn btn-info" style='line-height: 0.5;padding: .5rem'><i class="bi bi-pen"></i></a>
                                            <form class="spacing" method="POST" action='{{url("admin/delete/clientInfoModel/$data->id")}}'>
                                                @csrf
            ...
            @elseif(isset($query_domain_info) && $query_domain_info[0]->client_type_name == 'Domain')
                <div class="row">
                    <!-- column -->
                    <div class="col-12   m-auto">
                        <div class="card">
                ...
                @elseif(isset($query_hosting_info) && $query_hosting_info[0]->client_type_name == 'Hosting')
                <div class="row">
                    <!-- column -->
                    <div class="col-12   m-auto">
                        <div class="card">
                ...
                @elseif(isset($query_other_project_info) && $query_other_project_info[0]->client_type_name == 'project')
                <div class="row">
                    <!-- column -->
                    <div class="col-12   m-auto">
                        <div class="card">
