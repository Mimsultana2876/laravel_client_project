...
function insert(request $request){
    ...
    $this->validate($request,[
        ...
        "client_type_status" => "required",
    ],
    [
        'client_type_name.required'=> 'Please,Fill up Client Type Name',
        'client_type_status.required'=> 'Please, Select Status',
    ]);
    ...
    $user = DB::table('client_type')  
          ...
          if($user===null){
            ...
            $insert->client_type_status= $request->client_type_status;
            $insert->save();
    ...
    function update_page($id)
    {
     ...
     function update(request $request,$id)
     {
        ...
        if($user===null){
            ...
            $update->client_type_status= $request->client_type_status;
            $update->save();
